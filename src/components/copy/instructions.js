...
const Instructions = () => {
    const script = '<script src="https://cdn.jsdelivr.net/gh/owenmoore-xyz/token-art-tools@1.6.5/lib/connector.js"></script>';
    const code = 'console.log(hash, number);';
    const boilerplate = 'https://github.com/owenmoore-xyz/token-art-tools-boilerplate';
    ...
    return (
        ...
        >
            ...
            <Header as="h4">
                ...
                see the README for{' '}
                <a href="https://github.com/owenmoore-xyz/token-art-tools" target="_blank" rel="noreferrer">
